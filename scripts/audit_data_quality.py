...
def main():
    ...
    add("WARN-001","limitations","passed","dc_market.csv","all","road_distance_km",8,8,0,"category summary: same-city structural zero; record-level DST-003 rows remain warnings")
