...
Hard checks passed: 225; failed checks: 0.
...
Warnings are documented limitations: same-city structural zeros, the Jinhua proxy, specific listings, mixed source dates, and carbon_quota not_yet_generated.
